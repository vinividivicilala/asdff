  ...
  return (
    <div className={styles.home}>
      ...
      <ProjectSummary
        ...
        description="My personal blog website built using Next.js and Tailwind CSS, ability to upload blogs using markdown language called mdx."
      ...
      <ProjectSummary
        ...
        description="My personal portfolio website made using three.js on top of Next.js"
        buttonText="View project"
