...
import profileImgLarge from 'assets/ocean.jpeg';
import profileImgPlaceholder from 'assets/profile-placeholder.jpg';
import profileImg from 'assets/ocean.jpeg';
...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      related to Natural Language Processing and Machine Learning. At the same time I am
      actively on the lookout for remote internships which I can pursue in field of web and mobile development.
    </Text>
  </Fragment>
);
